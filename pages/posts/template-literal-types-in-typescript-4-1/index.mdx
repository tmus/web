...
<WarningCallout title="Watch out for upper limits!">
Union types generated this way have an upper limit on the amount of items they can contain. For example, I tried joining my HexPair type three times to create a RGBColor type, but got a “Expression produces a union type that is too complex to represent” error.
</WarningCallout>
